...
RUN R -e "install.packages(c('googlesheets4', 'dplyr', 'ggplot2', 'cli', 'crayon', 'expsmooth', 'fma', 'magrittr', 'purrr', 'forecast', 'rstudioapi', 'ggfortify', 'lubridate', 'memoise', 'openxlsx', 'scales', 'shiny', 'stringr', 'tibble', 'readr'), dependencies=TRUE)"
